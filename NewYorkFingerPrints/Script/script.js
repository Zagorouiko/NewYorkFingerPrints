(function() {
	...
	// Google Maps
	// ------------------------------------
	$('#map_manhattan').gmap({'scrollwheel': false}).bind('init', function() {
		$('#map_manhattan').gmap('addMarker', {'position': '40.7525906,-73.9941137', 'bounds': true}).click(function() {
			$('#map_manhattan').gmap('openInfoWindow', {'content': 'PrintScan Fingerprinting - Manhattan'}, this);
		});
		$('#map_manhattan').gmap('option', 'zoom', 17);
	});
